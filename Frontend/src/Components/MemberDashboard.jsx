...
//     fetchTickets();
//   });
//   // In your socket setup (where you initialize the socket)
// socket.on('ticket_reassigned', ({ ticket_id, assigned_to }) => {
//   setTickets(prev =>
//     prev.map(ticket =>
//       ticket.id === ticket_id ? { 
...
//     const { ticket, new_assignee } = responseData;
...
//     setNotifications(prev => [
//       ...prev,
//       { type: 'success', message: `Ticket #${ticket.id} reassigned to ${new_assignee.name}` }
//     ]);
...
//     setNotifications(prev => [
//       ...prev,
//       { type: 'error', message: `Reassign failed: ${err.message}` }
//     ]);
//   } finally {
