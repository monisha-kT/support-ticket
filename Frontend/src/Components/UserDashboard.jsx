...
// //   const debounceFilterUpdate = useCallback((field, value) => {
...
// //         permanent: true // Add this flag to prevent reopening
// //       }),
// //     });
...
// //     setNotification({
// //       type: 'success',
// //       message: 'Ticket closed permanently',
// //     });
...
// //       // For ID field, update immediately (or use a different approach if needed)
// //       setSearchFilters((prev) => ({
// //         ...prev,
// //         [field]: value,
// //       }));
// //     debounceFilterUpdate(field, value);
// //   };
...
// import useStore from '../store/useStore';
// import Navbar from './Navbar';
// import { getSocket , addSocketListener, disconnectSocket} from './socket';
// import ChatWindow from './ChatWindow';
...
//       // Ticket reassigned
//       addSocketListener('ticket_reassigned', ({ ticket_id, reassigned_to }) => {
...
//       // New message
//       addSocketListener('new_message', ({ ticket_id, message }) => {
//         console.log('New message received:', { ticket_id, message });
//         if (selectedTicket?.id === ticket_id) {
//           setSelectedTicket((prev) => ({
//             ...prev,
...
//       // Ticket accepted
//       addSocketListener('ticket_accepted', ({ ticket_id }) => {
//         console.log('Ticket accepted:', ticket_id);
//         setTickets((prev) =>
//           prev
//             .map((ticket) =>
//               ticket.id === ticket_id
...
//           }));
//         }
//         setNotification({ type: 'success', message: `Ticket #${ticket_id} has been accepted.` });
//       });

//       // Ticket rejected
//       addSocketListener('ticket_rejected', ({ ticket_id }) => {
//         console.log('Ticket rejected:', ticket_id);
//         setTickets((prev) =>
//           prev
//             .map((ticket) =>
//               ticket.id === ticket_id
...
//           }));
//         }
//         setNotification({ type: 'info', message: `Ticket #${ticket_id} has been rejected.` });
//       });
...
//                   }}
//                 >
//                   <TableCell sx={{ fontSize: '16px', fontWeight: 'bold', bgcolor: '#128C7E', color: 'white' }}>
//                     Ticket ID
//                   </TableCell>
//                   <TableCell sx={{ fontSize: '16px', fontWeight: 'bold', bgcolor: '#128C7E', color: 'white' }}>
//                     Subject
